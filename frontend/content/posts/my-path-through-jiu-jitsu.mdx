...
The first reason was the approach I had to the martial art itself: for me, it was not like other combat sports where you memorize a bunch of moves you can use. It was more like a chess match, where you are put in some uncomfortable situations and have a bunch of available tools to get rid of it. Every sparring session felt like a puzzle to be solved (and I’m a big videogames fan). As I got better, I learned more and better ways to solve puzzles and became a hard puzzle myself.
